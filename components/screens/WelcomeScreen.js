...
// import DevelopersPage from "./components/screens/DevelopersPage";
...
export default function WelcomeScreen() {
  ...
  const handleMeetDevelopersPress = () => {
    navigation.navigate('DevelopersScreen'); // Navigate to DevelopersScreen
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableHighlight
        onPress={handleMeetDevelopersPress}
